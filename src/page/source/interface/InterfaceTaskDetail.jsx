...
class InterfaceList extends React.Component{
    ...
    fetchTaskDetail=(entry)=>{
        ...
        var par = "entry="+entry
        fetch('http://ownerworld.win:5000/interfaceTaskDetail',{
            method: "POST",
            mode: "cors",
            headers: {
    ...
    fetchTask =()=>{
        ...
        fetch('http://ownerworld.win:5000/addInterfaceTask',{
            method: "POST",
            mode: "cors",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded"
    ...
    fetchClone=()=>{
        ...
        fetch('http://ownerworld.win:5000/cloneInterface',{
            method: "POST",
            mode: "cors",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded"
    ...
    clickDelete =(entry)=>{
        if(entry){
            var par = "entry="+entry
            fetch('http://ownerworld.win:5000/deleteInterface',{
                method: "POST",
                mode: "cors",
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded"
